/*
  ...
  - The values [APPROVED,COMPLETED] on the enum `RequestStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "RequestStatus_new" AS ENUM ('PENDING', 'IN_PROGRESS', 'RESOLVED', 'FULFILLED', 'REJECTED', 'CLOSED', 'CANCELLED', 'ON_HOLD');
